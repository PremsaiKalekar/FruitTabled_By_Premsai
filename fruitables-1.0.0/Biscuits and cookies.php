                        ...
                        <div class="col-lg-8 text-end">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <a href="index.php"> 
                                 ...
                                 <button type="button" class="btn btn-primary">patanjali</button>
                                 </a>
                                ...
                                <button type="button" class="btn btn-primary">Fruits</button>
                                </a>
                                ...
                                <li class="nav-item">
                                     <a href="Biscuits and cookies.php"> 
                                      <button type="button" class="btn btn-primary">Biscuits and cookies</button>
                                     </a>  
                                </li>
                                <bdi>&nbsp&nbsp</bdi>
                                ...
                                <li class="nav-item">
                                <a href="instance.php"> 
                                      <button type="button" class="btn btn-primary">Instance and ready food</button>
                                     </a>  
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="rounded position-relative fruite-item">
                            ...
                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                ...
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <p class="text-dark fs-5 fw-bold mb-0">RS <?php echo $rw[4];?>/-</p>
                                    <!-- Form for adding product to cart -->
                                    <form method="post" action="cart2.php?id=<?php echo $rw[0];?>">
                                        <input type="hidden" name="product_id" value="<?php echo $rw[0]; ?>">
                                        <button type="submit" name="add_to_cart"  class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</button>
                                    </form>
                                </div>
                            </div>
                        </div>
