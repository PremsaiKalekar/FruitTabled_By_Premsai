...
if(isset($_GET['id'])) {
    ...
    if (!$alreadyInCart) {
        $sql = "SELECT * FROM product3 WHERE id = $id";
...
$sql = "select * from product3  where id=1";
            ...
            <div class="row justify-content-end">
                <div class="col-md-4">
                    <div class="bg-light rounded p-4">
                        ...
                        <a class="btn btn-primary btn-block mt-4" href="checkout.php" role="button">PROCEED TO CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>
